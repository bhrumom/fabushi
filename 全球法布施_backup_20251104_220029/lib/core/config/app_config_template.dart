...
class AppConfig {
  ...
  static const List<String> supportedCountries = [
    'ALL', 'US', 'CN', 'IN', 'ID', 'BR', 'PK', 'NG', 'BD', 'RU',
    'MX', 'JP', 'ET', 'PH', 'EG', 'VN', 'CD', 'TR', 'IR', 'DE',
    'TH', 'GB', 'FR', 'IT', 'ZA', 'TZ', 'MM', 'KE', 'KR', 'CO',
    'ES', 'UG', 'AR', 'DZ', 'SD', 'UA', 'CA', 'PL', 'MA', 'SA',
    'UZ', 'PE', 'AF', 'MY', 'AO', 'MZ', 'GH', 'YE', 'NP', 'VE',
    'MG', 'AU', 'KP', 'CM', 'NE', 'TW', 'LK', 'BF', 'ML', 'RO',
    'MW', 'CL', 'KZ', 'ZM', 'GT', 'EC', 'SY', 'NL', 'SN', 'KH',
    'TD', 'SO', 'ZW', 'GN', 'RW', 'BJ', 'TN', 'BI', 'BO', 'HT',
    'BE', 'CU', 'SS', 'DO', 'CZ', 'GR', 'JO', 'PT', 'AZ', 'SE',
    'HN', 'HU', 'TJ', 'AE', 'BY', 'IL', 'TG', 'AT', 'RS', 'PG',
    'CH', 'SL', 'HK', 'LA', 'LY', 'BG', 'KG', 'NI', 'ER', 'TM',
    'SG', 'DK', 'FI', 'CG', 'SK', 'NO', 'OM', 'PS', 'CR', 'LB',
    'NZ', 'CF', 'IE', 'LR', 'MR', 'PA', 'GE', 'UY', 'BA', 'MN',
    'AM', 'JM', 'QA', 'AL', 'PR', 'LT', 'NA', 'GM', 'BW', 'GA',
    'SI', 'GW', 'HR', 'MK', 'LS', 'KW', 'XK', 'TT', 'EE', 'MU',
    'SZ', 'DJ', 'FJ', 'RE', 'CY', 'BH', 'KM', 'GQ', 'BT', 'ME',
    'SB', 'MO', 'LU', 'SR', 'CV', 'MV', 'MT', 'BN', 'BZ', 'IS',
    'BB', 'BS', 'PF', 'VU', 'NC', 'GY', 'ST', 'WS', 'LC', 'GD',
    'TO', 'VC', 'KI', 'MH', 'FM', 'PW', 'NR', 'TV',
  ];
