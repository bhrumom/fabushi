...
// .wrangler/tmp/bundle-3lWLu2/checked-fetch.js
...
var ALIPAY_CONFIG = {
  ...
  // 应用配置 (需要在支付宝开放平台配置)
  APP_CONFIG: {
    app_id: "2021005184653913",
    // 你的支付宝应用ID
    merchant_private_key: `-----BEGIN RSA PRIVATE KEY-----

-----END RSA PRIVATE KEY-----`,
    // 你的应用私钥
    alipay_public_key: "",
    // 支付宝公钥
    app_public_key: "",
    // 应用公钥
    charset: "utf-8",
    sign_type: "RSA2",
    version: "1.0",
...
var AlipayClient = class {
  static {
    __name(this, "AlipayClient");
  }
  constructor(config) {
    this.config = { ...ALIPAY_CONFIG.APP_CONFIG, ...config };
  }
  // 生成签名
  generateSign(params) {
    console.warn("\u8BF7\u4F7F\u7528\u652F\u4ED8\u5B9D\u5B98\u65B9SDK\u5B9E\u73B0\u7B7E\u540D\u529F\u80FD");
    return "";
  }
  // 创建当面付订单
  async createFaceToFacePayment(subject, totalAmount, outTradeNo, buyerId = null) {
    const bizContent = {
      subject,
  ...
  verifyNotifySign(params) {
    console.warn("\u8BF7\u4F7F\u7528\u652F\u4ED8\u5B9D\u5B98\u65B9SDK\u5B9E\u73B0\u7B7E\u540D\u9A8C\u8BC1");
    return true;
  }
  // 处理支付成功通知
  handlePaymentNotify(params) {
    ...
    if (tradeStatus === "TRADE_SUCCESS" || tradeStatus === "TRADE_FINISHED") {
      return {
        ...
        receiptAmount: parseFloat(params.receipt_amount || params.total_amount),
...
var MembershipOrderManager = class {
  static {
    __name(this, "MembershipOrderManager");
  }
  constructor(alipayClient2) {
    this.alipayClient = alipayClient2;
  }
  // 生成订单号
  generateOrderId(userId) {
    const timestamp = Date.now().toString();
    const random = Math.random().toString(36).substring(2, 8);
    return `MEMBER_${userId}_${timestamp}_${random}`;
  }
  // 创建会员购买订单
  async createMembershipOrder(userId, months = 1) {
    const orderId = this.generateOrderId(userId);
    const totalAmount = ALIPAY_CONFIG.MONTHLY_PRICE * months;
    const subject = `${months}\u4E2A\u6708\u4F1A\u5458\u670D\u52A1`;
    try {
      const orderParams = await this.alipayClient.createFaceToFacePayment(
        subject,
        totalAmount,
        orderId,
        userId
  ...
  async checkOrderStatus(orderId) {
    try {
      const queryParams = await this.alipayClient.queryOrder(orderId);
      return queryParams;
    } catch (error) {
...
var MembershipManager = class {
  static {
    __name(this, "MembershipManager");
  }
  constructor() {
    this.storageKey = "user_membership";
  }
  // 获取用户会员信息
  ...
  // 保存用户会员信息
  saveUserMembership(userId, membershipData) {
    localStorage.setItem(`${this.storageKey}_${userId}`, JSON.stringify(membershipData));
  }
  // 激活会员
  activateMembership(userId, months = 1) {
    const now = /* @__PURE__ */ new Date();
    ...
    this.saveUserMembership(userId, membershipData);
  ...
  checkMembershipStatus(userId) {
    ...
    const daysLeft = Math.ceil((endDate - now) / (1e3 * 60 * 60 * 24));
    return {
      isActive: daysLeft > 0,
      type: "paid",
...
var alipayClient = new AlipayClient(ALIPAY_CONFIG.APP_CONFIG);
var membershipOrderManager = new MembershipOrderManager(alipayClient);
...
\u6709\u6548\u671F10\u5206\u949F\uFF0C\u8BF7\u5C3D\u5FEB\u4F7F\u7528\u3002
\u5982\u975E\u672C\u4EBA\u64CD\u4F5C\uFF0C\u8BF7\u5FFD\u7565\u6B64\u90AE\u4EF6\u3002`;
    console.log("\u5F00\u59CB\u53D1\u9001\u90AE\u4EF6:", { email, subject });
    const sent = await sendEmail(email, subject, body, env);
    if (!sent.ok) {
      console.error("\u90AE\u4EF6\u53D1\u9001\u5931\u8D25:", sent.error);
      return jsonResponse({ error: "\u90AE\u4EF6\u53D1\u9001\u5931\u8D25", detail: sent.error }, 500);
    }
...
async function handleCreateAlipayOrder(request, env) {
  try {
    ...
    const { plan = "monthly", currency = "CNY" } = await request.json();
    const userData = await env.USERS_KV.get(`user:${tokenData.username}`);
    if (!userData) {
      return jsonResponse({ error: "\u7528\u6237\u4E0D\u5B58\u5728" }, 404);
    }
    const user = JSON.parse(userData);
    const membershipManager2 = new MembershipManager(env);
    const status = await membershipManager2.checkMembershipStatus(tokenData.username);
    if (status.isActive && status.type === "paid") {
      return jsonResponse({ error: "\u60A8\u5DF2\u7ECF\u662F\u4ED8\u8D39\u4F1A\u5458" }, 400);
    }
    const orderManager = new MembershipOrderManager(env);
    const order = await orderManager.createOrder(tokenData.username, plan);
    return jsonResponse({
...
async function handleQueryAlipayOrder(request, env) {
  try {
    ...
    const orderManager = new MembershipOrderManager(env);
    const order = await orderManager.queryOrder(orderId);
    return jsonResponse({
      orderId: order.orderId,
      status: order.status,
      amount: order.amount,
...
async function handleAlipayNotify(request, env) {
  try {
    ...
    if (tradeStatus === "TRADE_SUCCESS" || tradeStatus === "TRADE_FINISHED") {
      const orderManager = new MembershipOrderManager(env);
      await orderManager.markOrderAsPaid(orderId);
      const membershipManager2 = new MembershipManager(env);
      await membershipManager2.activateMembership(orderId);
    }
...
async function handleGetAlipayMembershipStatus(request, env) {
  try {
    ...
    console.error("\u83B7\u53D6\u652F\u4ED8\u5B9D\u4F1A\u5458\u72B6\u6001\u5931\u8D25:", error);
  ...
  try {
    ...
    for (const key of users.keys) {
      ...
      if (user.stripeCustomerId === customerId) {
        ...
        user.membershipEndDate = nextMonth.toISOString();
    ...
    for (const key of users.keys) {
      ...
      if (user.stripeCustomerId === customerId) {
        ...
        if (status === "active") {
          ...
          user.membershipType = "paid";
          user.membershipEndDate = periodEnd.toISOString();
...
// .wrangler/tmp/bundle-3lWLu2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3lWLu2/middleware-loader.entry.ts
