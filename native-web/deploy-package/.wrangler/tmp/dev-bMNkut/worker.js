...
// .wrangler/tmp/bundle-AY2yZ8/checked-fetch.js
...
async function handleCreateAlipayOrder(request, env) {
  try {
    ...
    const params = {
      ...
      notify_url: new URL(ALIPAY_CONFIG.CALLBACK_CONFIG.NOTIFY_URL, request.url).href,
      return_url: new URL(ALIPAY_CONFIG.CALLBACK_CONFIG.RETURN_URL, request.url).href,
...
// .wrangler/tmp/bundle-AY2yZ8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-AY2yZ8/middleware-loader.entry.ts
