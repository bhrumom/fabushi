...
//!
//! This module defines provider-neutral state machines for permissions, queued
//! input, context windows, task verification, attempt journals, and repeated
//! action protection. It deliberately depends only on stable Mahayana core
//! dependencies so model/provider adapters stay outside the product kernel.
