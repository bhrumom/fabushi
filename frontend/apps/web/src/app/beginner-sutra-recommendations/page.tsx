...
const sutraRecommendations = [
  {
    titleZh: "《心经》",
    titleEn: "Heart Sutra",
    fitZh: "适合想先接触佛法核心词汇，也想从经典里先感受“度一切苦厄”“心无罣碍”这一类般若方向的人。",
    fitEn: "A good first doorway if you want to meet core buddhist language and feel the Heart Sutra's movement from suffering toward fearlessness.",
    descriptionZh: "《心经》篇幅短、流通广，很多初学者会先从它建立熟悉感。经中直说“照见五蕴皆空，度一切苦厄”，又说依般若波罗蜜多故可以“心无罣碍；无罣碍故，无有恐怖，远离颠倒梦想”，后文并以“能除一切苦，真实不虚”总赞其力用。它不一定在第一次就能完全读懂，却很适合先反复听、反复读，让这些关键句慢慢进入心里。",
    descriptionEn: "The Heart Sutra is short and widely shared, so many beginners use it to build familiarity first. The text itself points toward relief from suffering, fearlessness, and freedom from distorted dreaming through prajna. It does not need to be fully understood at once, but it works well as a text you can hear and read repeatedly until a few key lines begin to land.",
  },
  {
    titleZh: "《阿弥陀经》",
...
const nextStepGuides = [
  ...
  },
  {
    ...
    descriptionZh: "很多人会先从《普门品》感到被安住，但继续往前走时，常常会追问：这种慈悲为什么不会只停在一时感动，而会慢慢长成更宽的修行方向？",
    ...
    <main className="inner-page">
      ...
      <section className="band compact-band">
        ...
        <div className="article-body">
          ...
          <p>
            <LocalizedText
              zh="传统学习常会把闻、思、修看成相续的过程。对初学者来说，这并不意味着一开始就要把很多经都读完，而是可以先通过听诵建立熟悉感，再读一小段原文或导读，最后留下一点真正触动自己的意思。Fabushi 更适合承接这条路径里的听诵、提醒和简短记录，让佛经学习可以真正进入生活。"
              en="Traditional learning often speaks of hearing, reflection, and practice as a living sequence. For beginners, that does not mean finishing many texts at once. It can begin with listening for familiarity, reading a short section or guide, and leaving one idea that truly stayed with you. Fabushi fits best on the listening, reminder, and short-note side of that path."
            />
          </p>
        </div>
      </section>
