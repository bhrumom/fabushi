...
Production candidate: **0.6.3**

Fabushi 0.6.3 is the official Chrome extension for the Fabushi product shell,
...
- `dist/chrome-extension/fabushi-chrome-0.6.3.zip`;
- `dist/chrome-extension/SHA256SUMS.txt`;
- `dist/chrome-extension/fabushi-chrome-0.6.3.content-manifest.json` with source
