...
Production candidate: **0.6.5**

Fabushi 0.6.5 is the official Chrome extension for the Fabushi product shell,
...
- `dist/chrome-extension/fabushi-chrome-0.6.5.zip`;
- `dist/chrome-extension/SHA256SUMS.txt`;
- `dist/chrome-extension/fabushi-chrome-0.6.5.content-manifest.json` with source
