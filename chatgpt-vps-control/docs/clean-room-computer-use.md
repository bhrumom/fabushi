...
- macOS TCC requests originate from a stable named Fabushi app bundle (`com.ombhrum.fabushi.computer-control`) rather than an anonymous Node/CLI process.
