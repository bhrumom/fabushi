...
class RealGlobalSendService {
  ...
  String _getCountryName(String countryCode) {
    ...
    final Map<String, String> countryNames = {
      ...
      'AO': '安哥拉', 'AG': '安提瓜和巴布达', 'AR': '阿根廷', 'AM': '亚美尼亚',
      'AU': '澳大利亚', 'AT': '奥地利', 'AZ': '阿塞拜疆', 'BS': '巴哈马',
      'BH': '巴林', 'BD': '孟加拉国', 'BB': '巴巴多斯', 'BY': '白俄罗斯',
      'BE': '比利时', 'BZ': '伯利兹', 'BJ': '贝宁', 'BT': '不丹', 'BO': '玻利维亚',
      'BA': '波斯尼亚和黑塞哥维那', 'BW': '博茨瓦纳', 'BR': '巴西', 'BN': '文莱',
      'BG': '保加利亚', 'BF': '布基纳法索', 'BI': '布隆迪', 'KH': '柬埔寨',
      'CM': '喀麦隆', 'CA': '加拿大', 'CV': '佛得角', 'CF': '中非共和国',
      'TD': '乍得', 'CL': '智利', 'CO': '哥伦比亚', 'KM': '科摩罗', 'CG': '刚果共和国',
      'CD': '刚果民主共和国', 'CR': '哥斯达黎加', 'CI': '科特迪瓦', 'HR': '克罗地亚',
      'CU': '古巴', 'CY': '塞浦路斯', 'CZ': '捷克共和国', 'DK': '丹麦', 'DJ': '吉布提',
      ...
      'NG': '尼日利亚', 'NO': '挪威', 'OM': '阿曼', 'PK': '巴基斯坦', 'PW': '帕劳',
      'PA': '巴拿马', 'PG': '巴布亚新几内亚', 'PY': '巴拉圭', 'PE': '秘鲁', 'PH': '菲律宾',
      'PL': '波兰', 'PT': '葡萄牙', 'QA': '卡塔尔', 'RO': '罗马尼亚', 'RU': '俄罗斯',
      ...
      'SS': '南苏丹', 'ES': '西班牙', 'LK': '斯里兰卡', 'SD': '苏丹', 'SR': '苏里南',
      ...
      'US': '美国', 'UY': '乌拉圭', 'UZ': '乌兹别克斯坦', 'VU': '瓦努阿图', 'VA': '梵蒂冈',
