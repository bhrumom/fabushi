...
| CWA-012 | Make installed Marketplace userscripts update from their own Tampermonkey-style `@updateURL` | CWA-005 + userscript metadata contract | CWA-R023; stale catalog does not block URL-based metadata/source update, identity and HTTPS checks | in-progress / source v2.9.38 published; host package pending | Protected host PR, packaged extension delivery, and live update readback |
