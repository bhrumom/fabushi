...
| AAC-004 | iOS Mini App account-scoped install/login + commerce authorization boundary | no second login/token leak/second payment ledger + exact-main journey | in-progress |
