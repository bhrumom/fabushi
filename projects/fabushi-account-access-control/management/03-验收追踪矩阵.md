...
| AAC-R011 | iOS Keychain / Android Keystore 注入 Rust encrypted account-session key | Rust secure-store regression + native compile + full-process relaunch | in-progress |
