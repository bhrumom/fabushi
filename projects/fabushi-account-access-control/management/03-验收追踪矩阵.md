...
| AAC-R011 | iOS Global Dharma uses current native session for account install/Pay, never exposes credentials to Mini App JS, and trusts only TFI canonical entitlement | protected CI + packaged account/Bot journey + Apple sandbox or exact external blocker | in-progress |
