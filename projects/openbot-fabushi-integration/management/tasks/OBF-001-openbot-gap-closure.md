...
Baseline: `main@9365b5e13f1fb5ac7b31f00049e487ab2174edbc`
...
- exact round baseline is now canonical `main@9365b5e13f1fb5ac7b31f00049e487ab2174edbc`;
...
- the PR currently also has an unrelated failing `GBF rollback drill` / previous-good release immutability check, so the repository state must not be described as all-green.
