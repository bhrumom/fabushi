...
| FCM-009.12 | Stabilize peer-switch E2E against dynamic peer-list reorder | yes | bind peers by stable test IDs; preserve identity assertion; exact-main Electron Linux/macOS/Windows journeys green | in-progress |
