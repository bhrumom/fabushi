...
## 2026-09-05 — protected #2345 merge and test-release gate

- Test-release group re-read canonical `main@dbf22b467d35c8af2a074896c355a41993c8c191`, exact product `#2345@9c46c1d8f030be390995cc78f321aac0d96b7f44`, independent review PASS provenance and records-only #2346 before taking any merge action.
- Active ruleset `main-merge-queue` required merge queue / SQUASH / ALLGREEN / `CI result` with no bypass actors. #2345 entered via auto-merge; no direct merge, rebase, retarget, force-push or special exemption was used.
- Queue ref `gh-readonly-queue/main/pr-2345-dbf22b...` produced group SHA `63e49b87d1ca5ad64d988e73769bf4a4ed796a19`. Merge-group CI run `33939126976` succeeded. Canonical job `101232897597` raw log proved expected/actual HEAD both equal that group SHA before the unchanged canonical script; required same-run `CI result` job `101233054947` also succeeded.
- #2345 merged at `2026-09-05T02:29:10Z`; immediate canonical-main readback was exact `63e49b87d1ca5ad64d988e73769bf4a4ed796a19`.
- Exact-main automatic post-main Electron `33939200878` and Native `33939200888` were allowed to run and are retained as observational CI/evidence runs. Existing workflow cache paths, packaged desktop journey and mobile emulator/simulator paths are reused; no local build/test/E2E was executed.
- Promotion to a compliant test-release candidate remains blocked because exact canonical main does not contain the independently frozen `IOS-FIXTURE-001`, `EVIDENCE-CONTRACT-001`, and `EVIDENCE-JOURNEY-001` prerequisite set. Architecture PR #2340 still holds those definitions as frozen/not-started; test-release did not implement or waive them.
- Added records-only task/evidence/management writeback. No application/test/workflow/Cargo/dependency/version implementation was modified by the test-release group; no stable/formal Release was created or modified by this group.
