...
## 2026-08-25 — M9-PAY-001 启动

- 启动全球法布施本地转经轮付费门槛：月付 CNY 30.00、买断 CNY 1080.00。
- 采用通用 Fabushi Pay capability entitlement，不建立全球法布施专用支付旁路。
- 验收包含 30 天续费、取消、到期、退款、重放幂等、全入口防绕过、可视化 E2E、protected merge 与 exact-main Release。
