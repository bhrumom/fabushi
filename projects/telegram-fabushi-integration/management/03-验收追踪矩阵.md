...
| 频道/Topic | conversation/community | M6 | IN_PROGRESS | Rust 订阅/广播、分页、Topic/慢速/审计切片已实现；待 CI、protected merge、canonical-main packaged E2E |
...
## TFI-M6-P0-001 acceptance — 2026-09-04
| Requirement | Evidence | State |
|---|---|---|
| RespondCommunityJoin compile/event boundary | exact reviewed head `1dc165489498889504a61b7e07d5164f25188cef`; atomic `33890057159` / `101079256166` | PASS task-specific / R2 B1 CLOSED |
| Community create/update authority | service idempotent create no-op + forged kind/owner/participant regression | PASS task-specific / R2 found no new runtime blocker |
| Missing Community regression | `RequestCommunityJoin -> CommunityNotFound` focused test | PASS task-specific |
| Non-Community create compatibility | focused ordinary Direct create test | PASS task-specific |
| Independent real-diff review | PR #2323 R2 comment `5543006832`; reviewer PR #2326 head `dfbae8a16531f325ab482e7dc4bdf6940b6f5f87` | REVIEW-REJECTED — B1/B2 CLOSED, B3 record-truth blocker |
| Required Rust CI | Mahayana `33890057133` / `101079256711`; Product Rust `33890057218` / `101079257348` | FAIL at formatter; later Rust checks SKIPPED |
| Protected merge + exact-main installable/package E2E + Release | no evidence yet; PR open/unmerged | BLOCKED/PENDING |

**R2 evidence correction:** earlier wording in this matrix that called these failures **inherited rustfmt** / **due inherited rustfmt** is explicitly withdrawn and superseded. This task has no independent exact base-vs-head formatter diagnostic for base `9e88a2e9c030fe05147460dfa580366cf9aa433d` versus reviewed head `1dc165489498889504a61b7e07d5164f25188cef`; the failure source could be base, PR, or mixed and is not determined by current evidence. Product Electron `101079257046` and atomic `101079256166` are PASS, but neither substitutes for the failed required Rust gates. Overall acceptance remains **BLOCKED**; no protected merge, exact-main packaged E2E/evidence bundle, or Release is claimed.
