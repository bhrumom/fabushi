...
|---|---|---|
| M8-GD-R01 single Tool Contract | live MCP inventory + Marketplace derivation contract | implemented / CI pending |
| M8-GD-R02 Bot/Web shared runtime | MCP Bot/Web integration + AccountSync `as1` journal | implemented / CI pending |
| M8-GD-R03 idempotency/recovery/isolation | runtime receipt + difference/snapshot + account isolation tests | implemented / CI pending |
| M8-GD-R04 permission/entitlement gate | Web approval static contract + denied/allowed MCP integration | implemented / CI pending |
| M9-GD-R05 CNY1080 order/webhook/refund/restore | canonical Fabushi Pay static/server contract tests | implemented / CI pending; live PSP blocked |
