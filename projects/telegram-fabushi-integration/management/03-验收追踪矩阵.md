...
## M6 MAINSAFE protected-merge and test-release acceptance — 2026-09-05

| Requirement / gate | State | Exact evidence |
|---|---|---|
| reviewed product immutability | PASS | `#2345@9c46c1d8f030be390995cc78f321aac0d96b7f44`; review `REVIEW-PASS-VERSION-EXACT-HEAD-CHECKOUT-001` |
| protected merge-group exact HEAD | PASS | run `33939126976`, job `101232897597`, expected/actual `63e49b87d1ca5ad64d988e73769bf4a4ed796a19` |
| required same-group `CI result` | PASS | job `101233054947` SUCCESS |
| canonical-main readback | PASS | `main@63e49b87d1ca5ad64d988e73769bf4a4ed796a19` |
| compliant exact-main packaged test-release | BLOCKED | canonical main lacks separately frozen `IOS-FIXTURE-001`, `EVIDENCE-CONTRACT-001`, `EVIDENCE-JOURNEY-001` prerequisite set |

Automatic post-main Electron/native Actions are preserved as observational evidence only. They do not substitute for the missing deterministic iOS fixture, owned end-to-end evidence journey, or evidence naming/retention/always-upload contract. No stable/formal release acceptance is authorized from this row.
