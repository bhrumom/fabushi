export const HOME = {
  ...
  "revision": "80476b5cee1598f69960703790a92f75291b20411f59597b1d08d7ddbb558b5c",
  "app": {
  ...
  "quickReplies": [
    {
      ...
      "label": "Web login and sync Action credentials",
      "aliases": [],
      "action": {
        "type": "tool",
