...
const nativeCommands = new Map([
  ...
  ['sync_actions_secrets', 'sync_actions_secrets'],
...
function runNativeTool(rpc) {
  ...
  if (tool === 'send_and_watch' || tool === 'add_connector' || [
    ...
    'cancel_task', 'sync_actions_secrets', 'login_and_sync_actions',
  ...
  const timeoutMs = tool === 'send_and_watch'
    ...
    : ['start_actions_runner', 'sync_actions_secrets', 'login_and_sync_actions', 'web_login_and_sync_actions'].includes(tool) ? 1_200_000 : 15_000;
