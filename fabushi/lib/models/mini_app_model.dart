...
MiniAppRegistry defaultMiniAppRegistry() {
  ...
  final bots = <MiniAppBot>[
    MiniAppBot(
      ...
      greeting: '把要分享的文字、链接或素材发给我，我会先回复数字选项；你确认后再启动全球法布施。',
      inputHint: '输入文字/链接，收到选项后回复数字',
    ...
    MiniAppBot(
      ...
      greeting: '粘贴经文、文章正文或链接，我会先回复制卡选项；你回复数字后再生成闪卡。',
      inputHint: '粘贴链接或正文，收到选项后回复数字',
    ...
    MiniAppBot(
      ...
      greeting: '把要发布的正文或链接发给我，我会先回复发布选项；你回复数字后再生成草稿或打开平台。',
      inputHint: '输入发布正文/链接，收到选项后回复数字',
