...
class HotspotManagerService {
  static const MethodChannel _channel = MethodChannel('com.fabushi.app/hotspot');
  ...
  Future<HotspotResult> _enableMacOSHotspot() async {
    try {
      ...
      // 尝试打开系统偏好设置的共享面板
      await Process.run('open', ['x-apple.systempreferences:com.apple.preferences.sharing']);
