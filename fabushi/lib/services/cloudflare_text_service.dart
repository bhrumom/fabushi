...
class CloudflareTextService {
  ...
  static final List<Map<String, String>> _sampleTexts = [
    {
      'title': '般若波罗蜜多心经',
      'filePath': 'assets/built_in/经文/般若波罗蜜多心经.txt',
...
故说般若波罗蜜多咒，即说咒曰：揭谛揭谛，波罗揭谛，波罗僧揭谛，菩提萨婆诃。''',
    ...
    {
      'title': '金刚般若波罗蜜经',
      'filePath': 'assets/built_in/乾隆大藏经txt版/大乘般若部/第0010部～金刚般若波罗蜜经三卷.txt',
      'content':
...
诵持此咒，能除一切痛苦，能破除一切邪恶，能治一切疾病，能成就一切善法，能消除一切灾难。''',
    ...
    {
      'title': '普贤菩萨行愿赞',
      'filePath': 'assets/built_in/乾隆大藏经txt版/西土圣贤撰集/第1137部～普贤菩萨行愿赞一卷.txt',
      'content':
