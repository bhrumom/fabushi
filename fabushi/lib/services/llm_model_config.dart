...
class LLMModelConfig {
  ...
  String get ramRequirement =>
      '${minRamMb >= 1024 ? '${(minRamMb / 1024).toStringAsFixed(1)} GB' : '$minRamMb MB'}+';
  ...
  static const Map<LLMModelType, LLMModelConfig> configs = {
    ...
    LLMModelType.qwen3VL2b: LLMModelConfig(
      ...
      mmprojDownloadUrl:
          'https://huggingface.co/Qwen/Qwen3-VL-2B-Instruct-GGUF/resolve/main/Qwen3-VL-2B-Instruct-mmproj-f16.gguf',
    ...
    LLMModelType.qwen3VL8b: LLMModelConfig(
      ...
      downloadUrl:
          'https://huggingface.co/bartowski/Qwen3-VL-8B-Instruct-GGUF/resolve/main/Qwen3-VL-8B-Instruct-Q4_K_M.gguf',
      ...
      mmprojDownloadUrl:
          'https://huggingface.co/bartowski/Qwen3-VL-8B-Instruct-GGUF/resolve/main/Qwen3-VL-8B-Instruct-mmproj-f16.gguf',
      mmprojSizeBytes: 1500 * 1024 * 1024, // ~1.5 GB
    ),
    ...
    LLMModelType.gemma4_e2b_gguf: LLMModelConfig(
      ...
      downloadUrl:
          'https://hf-mirror.com/tatsuyaaaaaaa/gemma-4-E2B-it-gguf/resolve/main/gemma-4-E2B-it_Q4_K_M.gguf',
    ...
    LLMModelType.gemma4_e4b_gguf: LLMModelConfig(
      ...
      downloadUrl:
          'https://hf-mirror.com/tatsuyaaaaaaa/gemma-4-E4B-it-gguf/resolve/main/gemma-4-E4B-it_Q5_K_M.gguf',
  ...
  static List<LLMModelConfig> get chatModels => configs.values
      .where(
        (c) =>
            c.category == LLMModelCategory.textOnly ||
  ...
  /// 获取当前平台可用的对话模型
  static List<LLMModelConfig> getChatModelsForPlatform({
