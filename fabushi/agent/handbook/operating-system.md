...
2. 如果没有适合自己的职位，按 `agent/handbook/self-onboarding.md` 自助创建身份。
3. 读自己的 `AGENT.md`、`status.md`、`memory.md`。
4. 读相关任务和当天聊天室。
5. 如果接到任务，把自己的 `status.md` 改到 `doing`。
6. 需要协作时，在聊天室追加消息。
7. 完成后更新任务、状态、报告和必要的长期记忆。
...
- 没有匹配角色：AI 可以先创建新身份，再在聊天室说明职责边界。
