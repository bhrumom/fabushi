...
echo "🌐 开始 Web 构建（排除大模型）..."

# 备份原始 pubspec.yaml
cp pubspec.yaml pubspec.yaml.backup

# 创建临时的 Web 专用 pubspec.yaml
...
dependencies:
  ...
  three_js_core: ^0.2.5
  three_js_math: ^0.2.4
  three_js_objects: ^0.2.1
  three_js_helpers: ^0.2.3
  three_js_core_loaders: ^0.2.1
  three_js_advanced_loaders: ^0.2.4
...
flutter:
  ...
  fonts:
    ...
    - family: NotoSerifSC
      fonts:
        - asset: fonts/NotoSerifSC-Regular.otf
        - asset: fonts/NotoSerifSC-Bold.otf
          weight: 700
EOF

echo "✅ 已创建 Web 专用配置（排除 assets/models/）"
