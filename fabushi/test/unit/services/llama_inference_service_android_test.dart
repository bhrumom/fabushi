    ...
    test(
      ...
      () async {
        ...
        if (!Platform.isAndroid) {
          print('Skipping Android-specific test on ${Platform.operatingSystem}');
          return;
        }
        ...
        // 2. Model file exists
        expect(await testModelFile.exists(), isTrue,
        ...
        await raf.close();
        expect(header, equals([0x47, 0x47, 0x55, 0x46]),
        ...
        print('Native libraries preloaded in MainActivity.kt: '
        ...
        try {
          ...
          expect(service.modelPath, equals(testModelFile.path),
          ...
          print('  The bug occurs because Llama.libraryPath is only set for macOS.');
          print('  On Android, the FFI binding cannot locate the preloaded native');
          print('  libraries, even though they are loaded via System.loadLibrary()');
